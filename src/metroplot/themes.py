...
class Theme:
    ...
    station_radius_factor: float = 1.0            # scale applied to interchange radius
    station_single_radius_factor: float = 1.0    # scale applied to single-line station radius
...
LIGHT = Theme(
    ...
    station_single_radius_factor=0.62,
    station_dot=False,
